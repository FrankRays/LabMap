...
$config['hosts'] = array('ldaps://its.uncc.edu');
...
$config['base_dn'] = 'OU=People,OU=unccharlotte,DC=its,DC=uncc,DC=edu';
...
$config['proxy_user'] = 'coeguardian';

// proxy pass: the password for the proxy_user
$config['proxy_pass'] = 'OCztsJ6QuAUXSw!';
